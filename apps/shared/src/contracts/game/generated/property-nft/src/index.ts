...
export interface Client {
   ...
   * Approve spender
   */
  approve: ({owner, spender, property_id}: {owner: string, spender: string, property_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   * Transfer property
   */
  transfer: ({from, to, property_id}: {from: string, to: string, property_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>

  /**
   * Construct and simulate a get_owner transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  get_owner: ({property_id}: {property_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<string>>

  /**
   * Construct and simulate a initialize transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Mint all 400 tiles to `treasury` logically.
   */
  initialize: ({treasury, game_engine}: {treasury: string, game_engine: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   * Get property
   */
  get_property: ({property_id}: {property_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<PropertyState>>
   ...
   */
  list_by_owner: ({owner}: {owner: string}, options?: MethodOptions) => Promise<AssembledTransaction<Array<u32>>>

  /**
   * Construct and simulate a transfer_from transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Transfer from approved spender
   */
  transfer_from: ({spender, from, to, property_id}: {spender: string, from: string, to: string, property_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  set_improvement_level: ({caller, property_id, level}: {caller: string, property_id: u32, level: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  set_last_claimed_ledger: ({caller, property_id, ledger}: {caller: string, property_id: u32, ledger: u64}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAADFByb3BlcnR5TWV0YQAAAAMAAAAAAAAAEGFwcHJvdmVkX3NwZW5kZXIAAAAEAAAAAAAAABNsYXN0X2NsYWltZWRfbGVkZ2VyAAAAAAYAAAAAAAAABWxldmVsAAAAAAAABA==",

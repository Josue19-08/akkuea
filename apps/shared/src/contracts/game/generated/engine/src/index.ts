...
export type StorageKey = {tag: "NftContract", values: void} | {tag: "TokenContract", values: void} | {tag: "Treasury", values: void} | {tag: "Initialized", values: void};
...
export interface Client {
   ...
   */
  improve: ({caller, property_id}: {caller: string, property_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>

  /**
   * Construct and simulate a initialize transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  initialize: ({nft_contract, token_contract, treasury}: {nft_contract: string, token_contract: string, treasury: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  claim_rental: ({caller, property_id}: {caller: string, property_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  get_accrued_income: ({property_id}: {property_id: u32}, options?: MethodOptions) => Promise<AssembledTransaction<i128>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAgAAAAAAAAAAAAAAClN0b3JhZ2VLZXkAAAAAAAQAAAAAAAAAAAAAAAtOZnRDb250cmFjdAAAAAAAAAAAAAAAAA1Ub2tlbkNvbnRyYWN0AAAAAAAAAAAAAAAAAAAIVHJlYXN1cnkAAAAAAAAAAAAAAAtJbml0aWFsaXplZAA=",
